...
class DoctorInfo:
  def __init__(self, text):
        #initialize
        self.education = "Not Found" #name of university, dont care if none
        self.age = None 
  ...
  def populate(self):
      ...
      for ind,field in enumerate(self.fields):          
          ...
          #get education (I am only taking first one mentioned)
          if("university" in field or "college" in field or "université" in field or "collège" in field or "institute" in field):
